...
type ConnectionState struct {
	...
	// CurveID is the curve used in the TLS 1.3 key exchange, or the curve
	// used to sign the server's certificate in TLS 1.2 (for ECDSA certificates).
	// For both TLS 1.2 and 1.3, this is zero if RSA is used.
	CurveID CurveID
	...
	// HelloRetryRequest is true if a HelloRetryRequest was sent/received.
